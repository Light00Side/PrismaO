...
#[derive(Debug)]
pub struct PrismaORMProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrismaORMProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrismaORM processing");
    
    let mut processor = PrismaORMProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrismaORMProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrismaORMProcessor::new(false);
